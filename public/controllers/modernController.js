document.addEventListener('DOMContentLoaded', () => {
    window.initializeModernController = function (canManage) {
        ...
        function poblarSelectOmitirTop() {
            const sel = $id('sorteo-omitir-top-modern');
            if (!sel) return;
        ...
        function lanzarSorteo() {
            const torneo = selectedTournament;
            const resultEl = $id('sorteo-resultado-modern');
            ...
            const omitirTop = parseInt($id('sorteo-omitir-top-modern')?.value || '0', 10);
            let num = parseInt($id('sorteo-numero-modern')?.value || '1', 10);
            if (Number.isNaN(num) || num < 1) num = 1;
            const contarRetirados = $id('sorteo-retirados-modern')?.checked || false;
        ...
        function setupEventListeners() {
            ...
            $id('sorteo-lanzar-modern')?.addEventListener('click', lanzarSorteo);
